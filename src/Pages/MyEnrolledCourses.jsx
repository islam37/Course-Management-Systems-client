...
const MyEnrolledCourses = () => {
  ...
  useEffect(() => {
    const fetchEnrollments = async () => {
      ...
      try {
        setLoading(true);
        const res = await axios.get(`http://localhost:3000/enrollments?email=${user.email}`);
        ...
        {enrollments.length === 0 ? (
          <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              You haven't enrolled in any courses. Explore our catalog to start your learning journey.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {enrollments.map((enroll) => (
              <div key={enroll._id} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                {/* Course Image */}
                ...
                {/* Course Content */}
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-3 line-clamp-2">{enroll.courseTitle}</h3>
                  <p className="text-gray-600 mb-4 line-clamp-3">{enroll.courseDescription}</p>
        ...
        {modal.show && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-xl">
              ...
              <h3 className="text-xl font-bold text-gray-900 text-center mb-2">Confirm Removal</h3>
              <p className="text-gray-600 text-center mb-6">
                Are you sure you want to remove your enrollment in <span className="font-semibold">"{modal.enrollment.courseTitle}"</span>?
              </p>
