...
const ContactUs = () => {
  ...
  const contactInfo = {
    ...
    email: "islamuddin3725@gmail.com",
    mobile: "+88 01568-289690",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${contactInfo.mobile}`} className="text-blue-600 hover:text-blue-700 transition-colors">
                      {contactInfo.mobile}
                    </a>
                  </div>
                </div>
              ...
              {/* Map Placeholder */}
              <div className="mt-8 bg-gradient-to-r from-blue-400 to-purple-500 rounded-xl p-1">
                <div className="bg-white rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600 text-sm">We're located in the heart of Sylhet city center</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 px-6 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <a
              key={index}
              href={item.link}
              className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 text-center group"
            >
